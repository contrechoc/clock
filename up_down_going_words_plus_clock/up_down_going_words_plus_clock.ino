...
void setup() {
  ...
  OCR1A = 100; //10 - 200    // compare match register 16MHz/256/2Hz
...
void loop() {
  ...
  myStr8Copy(myNumber, words[0] );
    moveWord(words[0], words[random(8)],words[random(8)]);
...
void upWord(unsigned char *wordArrayIN){
  ...
  myDelay(32000); myDelay(32000); myDelay(32000); myDelay(32000);
...
void downWord(unsigned char *wordArrayIN){ //later downword
  ...
  //---------------------------------------0 times
  myStr8Copy(wordArray4, myNumber);
    myDelay(32000); myDelay(32000); myDelay(32000); myDelay(32000); myDelay(32000);
